...
extern u8	APhaseReceBuf[PACK_SIZE];
extern u8	BPhaseReceBuf[PACK_SIZE];

extern u8 	EnableCorrectRegBuf[PACK_SIZE];
extern u8 	EnableMeterRegBuf[PACK_SIZE];		
extern u8 	ModeConfigBuf[PACK_SIZE];
extern u8 	AnalogModuleConfigBuf[PACK_SIZE];


void HT7038_Init(void);
//void HT7038Reset(void);
//void HT7038ResetSet(u8 state);
////////////////////////////////////////////////////////////////////
