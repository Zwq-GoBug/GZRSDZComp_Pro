...
{		
	...
	while(1)
	{
		...
		if( count < 20 )
		{
			...
			temp = (A_Original_Buf[count]/8192/RES_VALUE);
			a_changed_buf[count] = (u16)(temp*10);
			...
			temp = (B_Original_Buf[count]/8192/RES_VALUE);
			b_changed_buf[count] = (u16)(temp*10);
			count++;			
		}
		else
		{
