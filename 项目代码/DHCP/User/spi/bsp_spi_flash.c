...
void SPI_FLASH_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(	RCC_APB2Periph_GPIOA| 			//使能GPIOA&D时钟
	...
	SPI_InitStructure.SPI_Direction 		= SPI_Direction_2Lines_FullDuplex;	//设置为全线全双工模式
	SPI_InitStructure.SPI_Mode 				= SPI_Mode_Master;					//主机
	SPI_InitStructure.SPI_DataSize 			= SPI_DataSize_8b;					//数据长度为8bit
	SPI_InitStructure.SPI_CPOL 				= SPI_CPOL_High;					
	SPI_InitStructure.SPI_CPHA 				= SPI_CPHA_2Edge;
	SPI_InitStructure.SPI_NSS 				= SPI_NSS_Soft;						//有软件管理NSS(片选信号)
