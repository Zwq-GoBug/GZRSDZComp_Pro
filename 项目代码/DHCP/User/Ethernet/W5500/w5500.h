...
* @version V1.0
* @date    2015-xx-xx
* @brief   W5500¼Ä´æÆ÷µØÖ·¶¨Òå/ºê¶¨ÒåµÈ
* @attention
********************************************************************************/
#ifndef  __W5500_H_
#define  __W5500_H_
...
/**************************************** Í¨ÓÃ¼Ä´æÆ÷ ****************************************/
#define 	MR                          (0x000000)	//Ä£Ê½¼Ä´æÆ÷

#define 	GAR0                        (0x000100)	//Íø¹ØIPµØÖ·¼Ä´æÆ÷
#define 	GAR1                        (0x000200)
#define 	GAR2                        (0x000300)
#define 	GAR3                        (0x000400)

#define 	SUBR0                       (0x000500)	//×ÓÍøÑÚÂë¼Ä´æÆ÷
#define 	SUBR1                       (0x000600)
#define 	SUBR2                       (0x000700)
#define 	SUBR3                       (0x000800)

#define 	SHAR0                       (0x000900)	//Ô´MACµØÖ·¼Ä´æÆ÷
...
#define 	SIPR0                       (0x000F00)	//Ô´IPµØÖ·¼Ä´æÆ÷
#define 	SIPR1                       (0x001000)
#define 	SIPR2                       (0x001100)
#define 	SIPR3                       (0x001200)

#define 	INTLEVEL0                   (0x001300)	//µÍµçÆ½ÖÐ¶Ï¶¨Ê±Æ÷¼Ä´æÆ÷
...
/************************************** Socket¶Ë¿Ú¼Ä´æÆ÷ **************************************/
#define 		Sn_MR(ch)				(0x000008 + (ch<<5))	//SocketÄ£Ê½¼Ä´æÆ÷

#define 		Sn_CR(ch)               (0x000108 + (ch<<5))	//SocketÅäÖÃ¼Ä´æÆ÷

#define 		Sn_IR(ch)               (0x000208 + (ch<<5))	//SocketÖÐ¶Ï¼Ä´æÆ÷

#define 		Sn_SR(ch)               (0x000308 + (ch<<5))	//Socket×´Ì¬¼Ä´æÆ÷

#define 		Sn_PORT0(ch)            (0x000408 + (ch<<5))	//Socket n Ô´¶Ë¿Ú¼Ä´æÆ÷
#define 		Sn_PORT1(ch)            (0x000508 + (ch<<5))

#define 		Sn_DHAR0(ch)            (0x000608 + (ch<<5))	//Socket n Ä¿µÄ MAC µØÖ·¼Ä´æÆ÷
...
#define 		Sn_DIPR0(ch)            (0x000C08 + (ch<<5))	//Socket Ä¿±ê IP µØÖ·¼Ä´æÆ÷
#define 		Sn_DIPR1(ch)            (0x000D08 + (ch<<5))
#define 		Sn_DIPR2(ch)            (0x000E08 + (ch<<5))
#define 		Sn_DIPR3(ch)            (0x000F08 + (ch<<5))

#define 		Sn_DPORT0(ch)           (0x001008 + (ch<<5))	//Socket n Ä¿±ê¶Ë¿Ú¼Ä´æÆ÷
#define 		Sn_DPORT1(ch)           (0x001108 + (ch<<5))

#define 		Sn_MSSR0(ch)            (0x001208 + (ch<<5))	//Socket n-th ×î´ó·Ö¶Î¼Ä´æÆ÷
#define 		Sn_MSSR1(ch)            (0x001308 + (ch<<5))

#define 		Sn_PROTO(ch)            (0x001408 + (ch<<5))	//

#define 		Sn_TOS(ch)              (0x001508 + (ch<<5))	//Socket IP ·þÎñÀàÐÍ¼Ä´æÆ÷

#define 		Sn_TTL(ch)              (0x001608 + (ch<<5))	//Socket IP Éú´æÊ±¼ä¼Ä´æÆ÷

#define 		Sn_RXMEM_SIZE(ch)       (0x001E08 + (ch<<5))	//Socket n ½ÓÊÕ»º´æ´óÐ¡¼Ä´æÆ÷

#define 		Sn_TXMEM_SIZE(ch)       (0x001F08 + (ch<<5))	//Socket n ·¢ËÍ»º´æ´óÐ¡¼Ä´æÆ÷

#define 		Sn_TX_FSR0(ch)          (0x002008 + (ch<<5))	//Socket n ¿ÕÏÐ·¢ËÍ»º´æ¼Ä´æÆ÷
#define 		Sn_TX_FSR1(ch)          (0x002108 + (ch<<5))

#define 		Sn_TX_RD0(ch)           (0x002208 + (ch<<5))	//Socket n ·¢ËÍ¶ÁÖ¸Õë¼Ä´æÆ÷
#define 		Sn_TX_RD1(ch)           (0x002308 + (ch<<5))

#define 		Sn_TX_WR0(ch)           (0x002408 + (ch<<5))	//Socket n ·¢ËÍÐ´Ö¸Õë¼Ä´æÆ÷
#define 		Sn_TX_WR1(ch)           (0x002508 + (ch<<5))

#define 		Sn_RX_RSR0(ch)          (0x002608 + (ch<<5))	//Socket n ¿ÕÏÐ½ÓÊÕ»º´æ¼Ä´æÆ÷
#define 		Sn_RX_RSR1(ch)          (0x002708 + (ch<<5))

#define 		Sn_RX_RD0(ch)           (0x002808 + (ch<<5))	//Socket n ½ÓÊÕ¶ÁÖ¸Õë¼Ä´æÆ÷
#define 		Sn_RX_RD1(ch)           (0x002908 + (ch<<5))

#define 		Sn_RX_WR0(ch)           (0x002A08 + (ch<<5))	//Socket n ½ÓÊÕÐ´Ö¸Õë¼Ä´æÆ÷
#define 		Sn_RX_WR1(ch)           (0x002B08 + (ch<<5))

#define 		Sn_IMR(ch)				(0x002C08 + (ch<<5))	//Socket n ÖÐ¶ÏÆÁ±Î¼Ä´æÆ÷

#define 		Sn_FRAG(ch)				(0x002D08 + (ch<<5))	//Socket n ·Ö¶Î¼Ä´æÆ÷

#define 		Sn_KPALVTR(ch)			(0x002F08 + (ch<<5))	//Socket ÔÚÏßÊ±¼ä¼Ä´æÆ÷
